...
(function ($) {
    ...
    function logo_slider() {
       /* $('.logo-bar').slick({
        ...
        $('.logo-bar').animate({
            // إضافة خصائص التحريك
            left: "-=20px", // تحريك الشريط 20 بكسل إلى اليسار
            duration: 2000, // مدة التحريك 2 ثانية
            easing: "linear", // نوع التحريك خطي
            complete: function() {
              // بعد انتهاء التحريك، أعد الشريط إلى موقعه الأصلي
    ...
    function logo_slider() {
        $('.logo-bar').slick({
            ...
            autoplaySpeed: 1000, // سرعة التحرك (بالمللي ثانية)
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
